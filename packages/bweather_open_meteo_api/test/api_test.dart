...
const __citySample = City(name: "Chicago", elevation: 2.4, country: "America", latitude: 41.85003, longitude: -87.65005);
...
void main() {
    group('WeatherClient', () {
        ...
        setUp(() {
            ...
            apiClient = WeatherClient(httpClient: httpClient);
        });
        ...
        group('getWeather', () {
            test('throws WeatherRequestFailure on non-200 response', () async {
                ...
                when(() => response.statusCode).thenReturn(400);
                when(() => httpClient.get(any())).thenAnswer((_) async => response);
                expect(() async => apiClient.forecast(__citySample, tempUnit: "", precipitationUnit: "", windSpeedUnit: ""),
            ...
            test('returns weather on valid response', () async {
                ...
                final actual = await apiClient.forecast(__citySample, tempUnit: "", precipitationUnit: "", windSpeedUnit: "");
                expect(actual,
                    isA<Result>()
